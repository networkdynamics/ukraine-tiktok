...
def main():
    ...
    df_path = os.path.join(data_dir_path, 'cache', 'one_mil_english_comments_old.csv')
    ...
    embeddings_cache_path = os.path.join(data_dir_path, 'cache', 'english_comment_twitter_roberta_embeddings_old.npy')
